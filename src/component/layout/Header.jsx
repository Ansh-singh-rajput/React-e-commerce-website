...
<div className="row py-1 px-xl-5 text-secondary" style={{backgroundColor:'rgb(222 233 224)'}}>
<div className="col-lg-6 d-none d-lg-block">
<div className="d-inline-flex align-items-center h-100">
<a href="" className="nav-link aa ms-3">Home</a>
<a href="" className="nav-link aa ms-3">About</a>
...
{/*Navbar start */}
<div className="container-fluid mb-5 bg-success">
...
<li><a href="#" className="dropdown-item text-dark px-4 btn aa">Jeans</a></li>
<li><a href="#" className="dropdown-item text-dark px-4 btn aa"> Jacket</a></li>
<li><a href="#" className="dropdown-item text-dark px-4 btn aa">Blazzer</a></li>
</ul>
</div>
</div>
<div className="col-lg-9">
<nav className="navbar py-3 navbar-dark bg-success text-light navbar-expand-lg">
...
<ul className="navbar-nav">
  ...
  <li><Link to="/productdetails/:id" className="nav-link">Shop Details</Link></li>
  <div className="dropdown">
