                            ...
                            <div className="h-100 bg-white px-4 pt-3">
                                ...
                                <div className="d-flex mb-3">
                                    <div className="text-warning mr-2">
                                        <small className="fas fa-star">Rating:{products.rating}</small>

                                    </div>
                                    <small className="pt-1">Stock:{products.stock}</small>
                                </div>
                        ...
                        <div className="col-lg-3 mb-3">
                            <div className="card ">
                                ...
                                <div className="card-body bg-light">
                                    ...
                                    <h5 className="text-center">{products.price} <span className="text-danger"><del>$300</del></span></h5>
