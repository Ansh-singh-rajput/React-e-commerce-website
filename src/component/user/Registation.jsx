...
//                             <img className="w-100" src="/image/model.webp" alt="College Students Image-2"
//                                 height="100%" />
//                         </div>
//                         {/* <!-- End Column-1 --> */}
...
//                                 {/* <!-- logo --> */}
//                                 <center>
//                                     <img className="mb-4 rounded-circle" src="/image/fashion-logo-design.jpg" alt="Sign Up Image" width="20%" height="20%" />
//                                 </center>
...
//                                         <input value={name} onChange={(e) => setName(e.target.value)} className="form-control text-capitalize" type="text" placeholder="Enter your name" required />
//                                     </div>
//                                 </div>
...
//                                     <div className="col-lg-10">
//                                         <input value={email} onChange={(e) => setEmail(e.target.value)} className="form-control" type="email" placeholder="name@example.com" required />
//                                     </div>
//                                 </div>
...
//                                         <input value={confirmpassword} onChange={(e) => setconfirmPassword(e.target.value)} className="form-control" type="password" required />
//                                     </div>
//                                 </div>
...
//                                 {/* <!-- Button (Login) --> */}
//                                 <center>
//                                     <button type='submit' className="btn btn-primary mb-5 btn-lg">Register</button>
//                                 </center>
